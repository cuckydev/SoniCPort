...
extern int16_t scrposx, scrposy, bgscrposy;
extern int16_t scrposx_dup, scrposy_dup, bgscrposy_dup;
extern int32_t bgscrposx, bg2scrposx, bg3scrposx;
extern int16_t bgscrposx_dup, bg2scrposx_dup, bg3scrposx_dup;
extern int16_t bgscrposy_dup, bg2scrposy_dup, bg3scrposy_dup;
